...
function counter2(c) {
  const { o, s } = c;
  o.push("+", btn, "button", "element"), god(c);
  o.push("-", btn, "button", "element"), god(c);
  o.push("0", "text"), god(c);
}
...
function elm(c) {
  ...
  e.o = [];
  e.s = [elm_or, elm_and, elm_not];
  o.push(e);
  s[1](c);
}
function use_element(c) {
  const { o, s } = c;
  const eσ = o.pop();
  console.log("A", eσ);
  s[1](c);
...
function example(c) {
  const { o, s } = c;
  o.push("div", elm, use_element, and), o.pop()(c);
}

function ncount_or(c) {
  const { o, s } = c;
}
function ncount_add(c) {
  const { o, s } = c;
}
function ncount_not(c) {
  const { o, s } = c;
}
function ncount(c) {
  const { o, s } = c;
  o.push({ o: [], n: 0, s: [ncount_or, ncount_and, ncount_not] });
  s[1](c);
}
